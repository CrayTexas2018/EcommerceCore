...
namespace CoreEcommerce.Migrations
{
    ...
    [Migration("20170805202356_Products")]
    partial class Products
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("CoreEcommerce.Models.Product", b =>
                {
                    ...
                    b.Property<int?>("recurringProductproductId");
                    ...
                    b.HasIndex("recurringProductproductId");
            ...
            modelBuilder.Entity("CoreEcommerce.Models.Product", b =>
                {
                    b.HasOne("CoreEcommerce.Models.Product", "recurringProduct")
                        .WithMany()
                        .HasForeignKey("recurringProductproductId");
                });
        }
    }
}
